...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(fvDOMVeg, 0);
        addToRadiationRunTimeSelectionTables(fvDOMVeg);
    }
}
...
void Foam::radiation::fvDOMVeg::initialise()
{
    // 3D
    ...
    Info<< "fvDOMVeg : Allocated " << IRay_.size()
...
Foam::radiation::fvDOMVeg::fvDOMVeg(const volScalarField& T)
:
...
Foam::radiation::fvDOMVeg::fvDOMVeg
(
...
bool Foam::radiation::fvDOMVeg::read()
{
...
void Foam::radiation::fvDOMVeg::calculate()
{
...
Foam::tmp<Foam::volScalarField> Foam::radiation::fvDOMVeg::Rp() const
{
...
Foam::radiation::fvDOMVeg::Ru() const
{
...
void Foam::radiation::fvDOMVeg::updateBlackBodyEmission()
{
...
void Foam::radiation::fvDOMVeg::updateG()
{
...
void Foam::radiation::fvDOMVeg::setRayIdLambdaId
(
    const word& name,
    label& rayId,
    label& lambdaId
