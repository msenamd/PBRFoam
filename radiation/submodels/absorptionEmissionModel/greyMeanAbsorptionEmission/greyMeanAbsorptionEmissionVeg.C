...
#include "greyMeanAbsorptionEmissionVeg.H"
...
namespace Foam
{
    namespace radiation
    {
        defineTypeNameAndDebug(greyMeanAbsorptionEmissionVeg, 0);

        addToRunTimeSelectionTable
        (
            absorptionEmissionModel,
            greyMeanAbsorptionEmissionVeg,
            dictionary
        );
    }
}
...
Foam::radiation::greyMeanAbsorptionEmissionVeg::greyMeanAbsorptionEmissionVeg
(
...
Foam::radiation::greyMeanAbsorptionEmissionVeg::aCont(const label bandI) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::greyMeanAbsorptionEmissionVeg::eCont(const label bandI) const
{
   return aCont(bandI);
}
