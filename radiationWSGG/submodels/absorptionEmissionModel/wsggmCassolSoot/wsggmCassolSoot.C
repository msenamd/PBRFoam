...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmCassolSoot::aDisp(const label) const
{
    tmp<volScalarField> ta
    (
        new volScalarField
    ...
    {
        if (mesh_.foundObject<biomassCloud>(cloudNames_[i]))
        {
...
Foam::tmp<Foam::volScalarField>
Foam::radiation::wsggmCassolSoot::EDisp(const label bandI) const
{
    ...
    return tE / nBands_; //assume equal contribution to all bands
}
